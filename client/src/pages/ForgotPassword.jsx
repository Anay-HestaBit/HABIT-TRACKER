  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex items-center justify-center p-4">
      ...
      >
        <Link 
          to="/login"
          className="flex items-center gap-2 text-muted-foreground hover:text-foreground transition-all mb-6 group w-fit"
        >
          ...
          <div className="text-center">
            ...
            {devToken && (
                <div className="p-4 bg-emerald-500/10 border border-emerald-500/20 rounded-xl mb-6">
                    ...
                    <code className="text-foreground text-sm break-all">{devToken}</code>
                    <button 
