...
const FeatureCard = ({ icon: Icon, title, description, delay }) => (
  <motion.div
    ...
    viewport={{ once: true }}
    className="group relative p-8 rounded-[2.5rem] bg-card/50 border border-white/5 hover:border-blue-500/30 transition-all overflow-hidden"
  >
...
const Landing = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground selection:bg-primary/30">
      ...
      {/* Nav */}
      <nav className="fixed top-0 left-0 w-full z-50 border-b border-white/5 bg-background/70 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-6 py-5 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4 md:gap-8">
            <button
              onClick={toggleTheme}
              className="p-2 rounded-xl bg-secondary/50 text-muted-foreground hover:text-foreground transition-all"
              aria-label="Toggle theme"
            >
              {isDarkMode ? <Sun size={18} /> : <Moon size={18} />}
            </button>
          <div className="hidden md:flex items-center gap-8">
            <a href="#features" className="text-sm font-bold hover:text-foreground transition-colors uppercase tracking-widest">Features</a>
            <a href="#pricing" className="text-sm font-bold hover:text-foreground transition-colors uppercase tracking-widest">Why Us</a>
            <div className="h-4 w-[1px] bg-white/10" />
            <Link to="/login" className="text-sm font-bold hover:text-foreground transition-colors uppercase tracking-widest">Login</Link>
            <Link to="/signup" className="px-6 py-3 rounded-2xl bg-primary text-primary-foreground font-bold hover:bg-primary/90 transition-all shadow-xl shadow-primary/20">
              Get Started
            </Link>
          </div>
          </div>
      ...
      <main className="relative z-10 pt-44">
        ...
        <section className="max-w-7xl mx-auto px-6 mb-32">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <h1 className="text-6xl lg:text-8xl font-black leading-[0.9] text-foreground mb-8 tracking-tighter">
                Evolve Your <br />
              ...
              <div className="flex flex-col sm:flex-row items-center gap-6">
                <Link to="/signup" className="w-full sm:w-auto px-10 py-5 rounded-[2rem] bg-primary text-primary-foreground font-black text-xl flex items-center justify-center gap-3 hover:translate-y-[-4px] hover:shadow-[0_20px_40px_-15px_rgba(37,99,235,0.4)] transition-all shadow-xl">
                  Start Your Journey
                  <ArrowRight size={24} />
                </Link>
              </div>
              <div className="mt-12 flex items-center gap-10">
                ...
                <div className="text-sm font-bold">
                    <span className="text-foreground">Active Growth:</span> 2,400+ Users
                </div>
              </div>
              <motion.div
              ...
              >
                {['52-week heatmap', 'OTP sign-in', 'Streak shields', 'World evolution'].map((chip) => (
                  <span
                    key={chip}
                    className="px-4 py-2 rounded-full text-xs font-black uppercase tracking-widest bg-secondary/50 border border-white/5 text-muted-foreground"
                  >
                    {chip}
                  </span>
                ))}
            ...
            >
                <div className="aspect-square w-full rounded-[4rem] bg-gradient-to-br from-blue-600/20 to-transparent p-[1px]">
                  <div className="w-full h-full rounded-[4rem] bg-card/70 backdrop-blur-3xl p-12 relative overflow-hidden flex items-center justify-center">
                        <motion.div 
                            animate={{ 
                                rotateY: [0, 360],
                                y: [0, -20, 0]
                        ...
                        >
                            ...
                            <span className="font-black text-foreground text-lg">158 Days</span>
                            </div>
                          <p className="text-[10px] font-black uppercase tracking-widest text-muted-foreground">Master Streak</p>
                        </motion.div>
                        ...
                        >
                            ...
                            <span className="font-black text-foreground text-lg">Level 24</span>
                            </div>
                          <p className="text-[10px] font-black uppercase tracking-widest text-muted-foreground">World Evolution</p>
                        </motion.div>
                    </div>
                </div>
            </motion.div>
        ...
        <section className="max-w-5xl mx-auto px-6 py-40 text-center">
            <div className="relative p-16 rounded-[4rem] bg-gradient-to-b from-blue-600 to-indigo-700 overflow-hidden shadow-2xl shadow-blue-500/20">
                ...
                <div className="relative z-10">
                    <h2 className="text-4xl lg:text-7xl font-black text-primary-foreground mb-8 leading-tight tracking-tighter">Your evolution <br /> starts with a click.</h2>
                    <p className="text-primary-foreground/80 mb-12 text-lg font-medium max-w-xl mx-auto">Join the 1% who take their habits seriously. Transform your life and your digital world today.</p>
                    <Link to="/signup" className="px-12 py-6 rounded-[2rem] bg-primary-foreground text-primary font-black text-2xl hover:scale-105 transition-all shadow-2xl flex items-center gap-3 mx-auto w-fit">
        ...
        <footer className="max-w-7xl mx-auto px-6 py-20 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-10">
          ...
          <p className="text-sm font-bold text-muted-foreground uppercase tracking-widest">© 2026 Antigravity Labs. All rights reserved.</p>
            ...
            <a href="#" className="hover:text-foreground transition-colors text-sm font-bold uppercase tracking-widest">Privacy</a>
            </div>
        </footer>
      </main>
    </div>
